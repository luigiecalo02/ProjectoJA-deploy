...
/**
 * Catálogo DIVIPOLA usado por la DIAN.
 * Departamento: 2 dígitos. Municipio: 5 dígitos.
 *
 * @return list<array{codigo: string, nombre: string, municipios: list<array{codigo: string, nombre: string}>}>
 */
return [
    [
        'codigo' => '05',
