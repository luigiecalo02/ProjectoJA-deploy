...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $name = 'integrantes.manage_photos';

        $permissionId = DB::table('permissions')->where('name', $name)->value('id');
        $payload = [
            'display_name' => 'Colocar fotos de integrantes',
            'module' => 'integrantes',
            'page_id' => $pageId,
    ...
    public function down(): void
    {
        ...
        $permissionId = DB::table('permissions')->where('name', 'integrantes.manage_photos')->value('id');
        $pivot = Schema::hasTable('permission_role')
            ? 'permission_role'
            : (Schema::hasTable('role_permission') ? 'role_permission' : null);
