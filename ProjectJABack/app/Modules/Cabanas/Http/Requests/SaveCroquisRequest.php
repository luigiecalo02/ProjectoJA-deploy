...
class SaveCroquisRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'pisos.*.cuartos.*.camas.*.tipo' => ['nullable', 'in:sencilla,doble,multiple,camarote'],
            'pisos.*.cuartos.*.camas.*.nivel_camarote' => ['nullable', 'in:abajo,arriba'],
            'pisos.*.cuartos.*.camas.*.grupo_camarote' => ['nullable', 'string', 'max:64'],
            'pisos.*.cuartos.*.camas.*.precio_sugerido' => ['nullable', 'numeric', 'min:0'],
