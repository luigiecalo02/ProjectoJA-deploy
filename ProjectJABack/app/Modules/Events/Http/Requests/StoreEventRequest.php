...
class StoreEventRequest extends FormRequest
{
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator) {
            ...
            if (
                $this->input('participantes_genero') === 'mixto'
                && Event::mixtoQuotasExceedTotalMax(
                    $this->input('participantes_max'),
                    $this->input('participantes_min_m'),
                    $this->input('participantes_max_m'),
                    $this->input('participantes_min_f'),
                    $this->input('participantes_max_f'),
                )
            ) {
                $validator->errors()->add(
                    'participantes_max',
